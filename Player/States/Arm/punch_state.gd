...
func update(_delta: float):
	if Input.is_action_just_pressed("punch") and can_punch and start_delay_timer.is_stopped():
		...
		can_punch = false
	elif Input.is_action_just_pressed("equip") and can_equip_pistol and start_delay_timer.is_stopped():
